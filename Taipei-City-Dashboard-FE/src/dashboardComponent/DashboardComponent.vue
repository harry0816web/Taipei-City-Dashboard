...
import EVStationChart from "./components/EVStationChart.vue";
import EVRealtimeChart from "./components/EVRealtimeChart.vue";
...
import EVStationChartSvg from "./assets/chart/BarChart.svg";
import EVRealtimeChartSvg from "./assets/chart/BarPercentChart.svg";
...
function returnChartComponent(name, svg) {
	...
	case "EVStationChart":
		return svg ? EVStationChartSvg : EVStationChart;
	case "EVRealtimeChart":
		return svg ? EVRealtimeChartSvg : EVRealtimeChart;
	default:
		return svg ? MapLegendSvg : MapLegend;
	}
}
